...
class StreamConsumerManager:
    ...
    async def _process_single_message(self, stream_name: str, message_id: str, fields: Dict):
        ...
        try:
            ...
            logger.info("message_processed_successfully",
                       message_id=message_id,
    ...
    async def _handle_student_response(self, message: StreamMessage) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(self, 'collaborative_filter'):
                ...
                self.collaborative_filter.add_interaction(student_id, question_id, rating)
            
            logger.info("student_response_processed",
    ...
    async def _handle_recommendation_feedback(self, message: StreamMessage) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info("recommendation_feedback_processed",
                       student_id=student_id,
                       question_id=question_id,
    ...
    async def _handle_collaborative_update(self, message: StreamMessage) -> Dict[str, Any]:
    ...
    async def _handle_processing_error(self, message_id: str, fields: Dict, error: Exception):
        ...
        try:
            ...
            if retry_count < self.max_retries:
                ...
                logger.warning("message_retried",
                              message_id=message_id,
                ...
                logger.error("message_sent_to_dlq",
                            message_id=message_id,
                            error=str(error))
            ...
            logger.error("dlq_handling_error", 
                        message_id=message_id,
                        error=str(dlq_error))
    ...
    async def publish_message(self, message_type: MessageType, data: Dict[str, Any]) -> str:
