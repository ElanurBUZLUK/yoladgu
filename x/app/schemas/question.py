...
class ClozeQuestionSchema(BaseModel):
    original_sentence: str = Field(..., description="The original sentence from which the cloze question is derived.")
    cloze_sentence: str = Field(..., description="The sentence with the blank(s) for the cloze question.")
    correct_answer: str = Field(..., description="The word or phrase that correctly fills the blank.")
    distractors: List[str] = Field(..., description="A list of incorrect options for multiple-choice cloze questions.")
    error_type_addressed: str = Field(..., description="The type of error this cloze question aims to address.")
    rule_context: Optional[str] = Field(None, description="The grammatical rule or context relevant to this cloze question.")
    difficulty_level: int = Field(..., ge=1, le=5, description="Estimated difficulty level of the cloze question.")
