...
class ErrorCode:
    ...
    ENGLISH_CLOZE_ERROR = "ENGLISH_CLOZE_ERROR"
    MATH_RECOMMENDATION_ERROR = "MATH_RECOMMENDATION_ERROR"
    
    # RAG-specific errors
    RAG_SEARCH_ERROR = "RAG_SEARCH_ERROR"
    RAG_STATISTICS_ERROR = "RAG_STATISTICS_ERROR"
    SEARCH_VECTOR_UPDATE_ERROR = "SEARCH_VECTOR_UPDATE_ERROR"
    
    # MCP-specific errors
    MCP_TOOL_ERROR = "MCP_TOOL_ERROR"
    MCP_CONTEXT_ERROR = "MCP_CONTEXT_ERROR"
    MCP_METRICS_ERROR = "MCP_METRICS_ERROR"
    MCP_HEALTH_ERROR = "MCP_HEALTH_ERROR"
