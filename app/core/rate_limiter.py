...
class AdvancedRateLimiter:
    ...
    async def check_rate_limit(self, request: Request) -> Optional[JSONResponse]:
        ...
        try:
            ...
            for window_name, window_seconds, limit in windows:
                ...
                key = self.get_rate_limit_key(user_identifier, endpoint_key, f"{window_name}:{window_start}")
                ...
                if current_count >= burst_limit:
                    ...
                    return JSONResponse(
                        ...
                        headers={
                            ...
                            "X-RateLimit-Remaining": str(max(0, burst_limit - current_count - 1)),
        ...
        try:
            ...
            if cached_data:
                try:
                    ...
                    logger.debug("cache_hit", cache_key=cache_key[-12:], endpoint=endpoint_key)
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            memory_usage = sum(self.redis.memory_usage(key) for key in rate_limit_keys[:100])  # Sample
