...
def get_plan_items(db: Session, plan_id: Optional[int] = None, skip: int = 0, limit: int = 100) -> List[PlanItem]:
...
def update_plan_item(db: Session, db_obj: PlanItem, item_in: PlanItemUpdate) -> PlanItem:
