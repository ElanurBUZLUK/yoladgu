...
def get_solutions(db: Session, user_id: Optional[int] = None, skip: int = 0, limit: int = 100) -> List[Solution]:
...
def update_solution(db: Session, db_obj: Solution, solution_in: SolutionUpdate) -> Solution:
