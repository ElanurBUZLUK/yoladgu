...
# Mock user data
mock_user = User(id=1, username="testuser", email="test@example.com", current_math_level=1, current_english_level=1)
...
app.dependency_overrides[auth_middleware.get_current_teacher] = override_get_current_teacher
app.dependency_overrides[auth_middleware.get_current_student] = override_get_current_student

@pytest.fixture
def mock_llm_gateway():
    with patch("app.services.llm_gateway.llm_gateway.generate_json", new_callable=AsyncMock) as mock_generate_json:
