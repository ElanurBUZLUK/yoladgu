...
def upgrade() -> None:
    ...
    op.add_column('questions', sa.Column('content_embedding', sa.Text(), nullable=True))  # Will be cast to vector later
    ...
    op.add_column('error_patterns', sa.Column('embedding', sa.Text(), nullable=True))  # Will be cast to vector later
