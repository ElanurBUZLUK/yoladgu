...
def _sync_student_response_to_neo4j(
    ...
    try:
        ...
        logger.info(
            "student_response_synced_to_neo4j",
            student_id=student_id,
            question_id=question_id,
            is_correct=is_correct,
        )
        ...
        logger.error(
            "neo4j_student_response_sync_error",
            student_id=student_id,
            question_id=question_id,
            error=str(e),
        )
...
def get_responses(
    db: Session, student_id: Optional[int] = None, skip: int = 0, limit: int = 100
...
def get_student_learning_path_from_neo4j(
