...
@router.post("/", response_model=schemas.PlanItemResponse, status_code=status.HTTP_201_CREATED)
def create_plan_item(
    ...
    """
    return crud_plan_item.create_plan_item(db=db, item_in=item_in, plan_id=item_in.plan_id)
