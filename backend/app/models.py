...
class User(Base):
    ...
    created_at: Mapped = mapped_column(DateTime(timezone=False), server_default=func.now())
...
class RefreshToken(Base):
    ...
    expires_at: Mapped = mapped_column(DateTime(timezone=False))
    created_at: Mapped = mapped_column(DateTime(timezone=False), server_default=func.now())
...
class TeacherStudentRequest(Base):
    ...
    created_at: Mapped = mapped_column(DateTime(timezone=False), server_default=func.now())
    updated_at: Mapped = mapped_column(DateTime(timezone=False), server_default=func.now())
...
class Assignment(Base):
    ...
    due_date: Mapped = mapped_column(DateTime(timezone=False), nullable=True)
